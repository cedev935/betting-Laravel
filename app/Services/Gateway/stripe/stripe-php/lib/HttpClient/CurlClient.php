...
class CurlClient implements ClientInterface
{
    ...
    public function request($method, $absUrl, $headers, $params, $hasFile)
    {
        ...
        if ($errno == CURLE_SSL_CACERT ||
            ...
            array_push(
                $headers,
                'X-StripeJS-Client-Info: {"ca":"using StripeJS-supplied CA bundle"}'
            );
            $cert = self::caBundle();
    ...
    private function handleCurlError($url, $errno, $message)
    {
        switch ($errno) {
            ...
            case CURLE_OPERATION_TIMEOUTED:
                $msg = "Could not connect to StripeJS ($url).  Please check your "
                 . "internet connection and try again.  If this problem persists, "
                 . "you should check StripeJS's service status at "
                 . "https://twitter.com/StripeJSstatus, or";
                break;
            case CURLE_SSL_CACERT:
            case CURLE_SSL_PEER_CERTIFICATE:
                $msg = "Could not verify StripeJS's SSL certificate.  Please make sure "
                 . "that your network is not intercepting certificates.  "
                 . "(Try going to $url in your browser.)  "
                 . "If this problem persists,";
                break;
            default:
                $msg = "Unexpected error communicating with StripeJS.  "
                 . "If this problem persists,";
        }
