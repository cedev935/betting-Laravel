...
/**
 * Base class for StripeJS test cases, provides some utility methods for creating
 * objects.
 */
class TestCase extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $apiKey = getenv('StripeJS_API_KEY');
        if (!$apiKey) {
            $apiKey = self::API_KEY;
        }

        StripeJS::setApiKey($apiKey);
    }
    ...
    protected function setUp()
    {
        ...
        StripeJS::setApiVersion('2017-04-06');
    ...
    private function setUpMockRequest()
    {
        if (!$this->mock) {
            ...
            $this->mock = $this->getMock('\StripeJS\HttpClient\ClientInterface');
