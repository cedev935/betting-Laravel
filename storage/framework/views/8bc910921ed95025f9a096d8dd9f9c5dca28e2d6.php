<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Game Category List'); ?>
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                    ...
                    <tr>
                        ...
                        <th scope="col"><?php echo app('translator')->get('Active Tournament'); ?></th>
                        <th scope="col"><?php echo app('translator')->get('Active Team'); ?></th>
                        <th scope="col"><?php echo app('translator')->get('Active Match'); ?></th>
                        <th scope="col" class="text-center"><?php echo app('translator')->get('Icon'); ?></th>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td data-label="<?php echo app('translator')->get('Active Tournament'); ?>">
                                <span class="badge badge-info"><?php echo e($item->active_tournament_count); ?></span>
                            </td>
                            <td data-label="<?php echo app('translator')->get('Active Team'); ?>">
                                <span class="badge badge-success"><?php echo e($item->active_team_count); ?></span>
                            </td>
                            <td data-label="<?php echo app('translator')->get('Active Match'); ?>">
                                <span class="badge badge-warning"><?php echo e($item->active_match_count); ?></span>
                            </td>
                            <td data-label="<?php echo app('translator')->get('Icon'); ?>" class="text-lg-center text-right">
                                <?php echo $item->icon; ?>
                                    ...
                                    <div class="dropdown show dropup text-lg-center text-right">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            <a class="dropdown-item editBtn" href="javascript:void(0)"
                                               data-title="<?php echo e($item->name); ?>" data-icon="<?php echo e($item->icon); ?>"
                                               data-status="<?php echo e($item->status); ?>"
                                               data-action="<?php echo e(route('admin.updateCategory', $item->id)); ?>">
                                            ...
                                            <a class="dropdown-item notiflix-confirm" href="javascript:void(0)"
                                               ...
                                               data-route="<?php echo e(route('admin.deleteCategory',$item->id)); ?>"
                                               data-toggle="modal">
    ...
    <div class="modal fade" id="all_inactive" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><?php echo app('translator')->get("Are you really want to Deactive the Category"); ?></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-dismiss="modal"><span><?php echo app('translator')->get('No'); ?></span></button>
                    <form action="" method="post">
    ...
    <div id="newModal" class="modal fade show" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.storeCategory')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="text-dark"><?php echo app('translator')->get('Title'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            <label class="text-dark"><?php echo app('translator')->get('Icon'); ?></label>


                            <select name="icon" id="icon" class="form-control" class="selectpicker"
                                    data-live-search="true">
                                <option value="" selected disabled><?php echo app('translator')->get('Select Icon'); ?></option>
                                <?php $__currentLoopData = $games; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value); ?>" data-content="<?php echo e($value); ?> <?php echo e($key); ?>">
                                        <?php echo e($key); ?> </i>
                                    </option>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div id="editModal" class="modal fade show" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-primary">
                    <h5 class="modal-title"><?php echo app('translator')->get('Edit Game'); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="icon" id="editIcon" class="form-control selectpicker" data-live-search="true">
                                <option value="" selected disabled><?php echo app('translator')->get('Select Icon'); ?></option>
                                <?php $__currentLoopData = $games; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e(old('icon',$value)); ?>" data-content="<?php echo e($value); ?> <?php echo e($key); ?>">
                                        <?php echo e($key); ?> </i>
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        $(document).on('click', '.inactive-yes', function (e) {
            ...
            $.ajax({
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf_token"]').attr('content')},
                url: "<?php echo e(route('admin.category-deactive')); ?>",
                data: {strIds: strIds},
                datatType: 'json',
                type: "post",
                success: function (data) {
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\work\betting\orca odd\resources\views/admin/category/list.blade.php ENDPATH**/ ?>