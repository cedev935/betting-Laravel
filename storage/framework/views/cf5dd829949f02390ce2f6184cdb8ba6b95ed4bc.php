    ...
    <div  :class="{ 'd-none': 0 == betSlip.length }">
        <div class="mb-2">
            <div class="d-flex justify-content-between">
                <p class="mb-0"><?php echo app('translator')->get('Your Bets'); ?> {{ betSlip.length }}</p>
        ...
        <div class="mb-3">
            <p class="mb-1">
                <?php echo app('translator')->get('Overall Odds'); ?> <span class="float-end">{{ totalOdds }}</span>
            </p>
            <p class="mb-1">
                <?php echo app('translator')->get('Maximum stake amount'); ?> <span class="float-end">{{ minimum_bet }} {{ currency }}</span>
            </p>
            <p class="mb-1">
                <?php echo app('translator')->get('Charge Apply'); ?> <small> (IF YOU WIN) </small><span class="float-end">{{win_charge}}%</span>
            </p>

            <p class="mb-1">
                <?php echo app('translator')->get('Potential Winnings'); ?> <span class="float-end">{{ return_amount }} {{ currency }}</span>
            </p>
        </div>
        ...
        <button type="button" @click="betPlace" class=" btn-custom w-100"><?php echo app('translator')->get('place bet'); ?></button>
    </div>
</div>
<?php /**PATH F:\work\betting\orca odd\resources\views/themes/betting/partials/home/rightbar.blade.php ENDPATH**/ ?>